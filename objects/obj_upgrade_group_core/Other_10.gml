...
nested_items[0] = instance_create_layer(x, y, "Instances", obj_upgrade_core_shields);
...
nested_items[1] = instance_create_layer(x, y, "Instances", obj_upgrade_core_more_metal);
...
nested_items[2] = instance_create_layer(x, y, "Instances", obj_upgrade_core_gun_speed);
