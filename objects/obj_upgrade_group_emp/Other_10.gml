...
nested_items[0] = instance_create_layer(x, y, "Instances", obj_upgrade_emp_duration);
...
nested_items[1] = instance_create_layer(x, y, "Instances", obj_upgrade_emp_cooldown);
