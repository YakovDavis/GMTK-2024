...
root_level_items[0] = instance_create_layer(x, y, "Instances", obj_upgrade_group_shield);
...
root_level_items[3] = instance_create_layer(x, y, "Instances", obj_upgrade_group_core);
